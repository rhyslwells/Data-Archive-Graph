Below is a **concise, actionable feature roadmap**, ordered by **build complexity and necessity**, starting from a minimal but useful initial build and progressing toward your longer-term Graph-RAG vision. Wording is implementation-oriented and suitable for direct translation into issues or milestones.
