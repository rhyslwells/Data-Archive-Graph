...
TFIDF_Score to be added to json (save as new file). Similar for inlinks and out links.

File selector from json using the (filename)

-----

The goal is to analyze and explore the Data Archive using the built JSON file, focusing on note relationships. This will help in identifying key connections and themes. which can be useful for knowledge management and retrieval.
