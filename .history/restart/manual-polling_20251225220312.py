...
Purpose
-------
Fast manual polling snapshot of `content/categories` with parallel
file downloads and stable JSON output.
"""
...
HEADERS = {
    ...
    "Authorization": "Bearer YOUR_GITHUB_TOKEN"  # strongly recommended
}
...
def main():
    ...
    print("Downloading files (parallel)...")
    with ThreadPoolExecutor(max_workers=MAX_WORKERS) as executor:
        futures = {executor.submit(fetch_file, f): f for f in files}
