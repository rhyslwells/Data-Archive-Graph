...
* (i am open to similarity features) Do you want **strict interpretability** (TF–IDF, LDA only), or are you open to adding embedding-based similarity as a parallel channel?
* (No read only) Should this class mutate notes (e.g. write tags back to front-matter), or remain read-only?
